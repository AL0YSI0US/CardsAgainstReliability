...
\node [cardfg,below right] at (2.2in + 0.12in, 0.72in) {\titlefont Reliability};
...
Cards Against Reliability is a fork of Cards Against Cryptography. It is based on Cards Against Humanity, which was released under a Creative Commons BY-NC-SA 2.0 license.}
	...
	{\sffamily\fontsize{8}{8}\selectfont
	The source code and printable PDF versions of Cards Against Reliability are available online at dastergon.gr/CardsAgainstReliability/. You can also submit pull requests to propose new cards.
	}
};
\end{tikzpicture}
\end{document}
